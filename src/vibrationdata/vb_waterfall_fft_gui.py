...
from vibrationdata.vb_utilities import sample_rate_check, read_two_columns_from_dialog
...
################################################################################
        ...
        self.hwtext3b.grid(row=crow, column=1, columnspan=1,
                           pady=7, sticky=tk.S)
...
################################################################################
        ...
        self.button_read.grid(row=crow, column=0,
                              columnspan=1, padx=0, sticky=tk.W)
...
################################################################################
        ...
        self.button_process.grid(
            row=crow, column=0, padx=5, pady=1, sticky=tk.N)
...
################################################################################
        ...
        self.hwtexto.grid(row=crow, column=2, columnspan=1,
                          padx=10, pady=3, sticky=tk.S)
...
################################################################################
        ...
        self.button_calculate = tk.Button(
            top, text="Calculate", command=self.waterfall_FFT_calculation)
