...
################################################################################
        ...
        self.hwtext1 = tk.Label(
            top, text='Pierson-Moskowitz Ocean Wave Height PSD')
        ...
        self.hwtext2 = tk.Label(
            top, text='Select the wind speed (m/sec) at a height of 19.5 m above the sea surface')
        self.hwtext2.grid(row=crow, column=0, columnspan=4,
                          pady=7, sticky=tk.W)
...
################################################################################
        ...
        self.button_calculate.grid(
            row=crow, column=1, columnspan=1, padx=5, pady=10, sticky=tk.S)
...
################################################################################
        ...
        self.button_sav.grid(row=crow, column=2, columnspan=1,
