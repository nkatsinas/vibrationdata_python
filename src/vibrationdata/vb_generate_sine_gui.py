...
class vb_generate_sine:
    ...
    def __init__(self, parent):
        ...
        self.hwtext17.grid(row=crow, column=1, columnspan=1,
                           padx=10, pady=10, sticky=tk.S)

        self.hwtext41 = tk.Label(top, text='Title')
        self.hwtext41.grid(row=crow, column=2, columnspan=1,
                           padx=10, pady=10, sticky=tk.S)
        ...
        self.ylabel_string_entry.grid(
            row=crow, column=1, columnspan=1, padx=10, pady=1, sticky=tk.N)
        ...
        self.t_string_entry.grid(
            row=crow, column=2, columnspan=1, padx=10, pady=1, sticky=tk.N)
