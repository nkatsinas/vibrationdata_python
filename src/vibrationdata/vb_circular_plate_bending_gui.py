...
class vb_circular_plate_bending:
    ...
    def __init__(self, parent):
        ...
        self.master.title(
            "vb_circular_plate_bending_gui.py ver 1.0  by Tom Irvine")
...
################################################################################
    ...
    def PerformAnalysis(self):
        ...
        if (n == m):
            from vibrationdata.vb_circular_homogeneous_gui import vb_circular_homogeneous
            vb_circular_homogeneous(win)

        m = m+1

        if (n == m):
            from vibrationdata.vb_circular_honeycomb_gui import vb_circular_honeycomb
