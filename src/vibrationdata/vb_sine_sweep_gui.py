...
class vb_sine_sweep:
    def __init__(self, parent):
        ...
        self.Lb2.grid(row=crow, column=1, columnspan=1,
                      padx=5, pady=4, sticky=tk.N)
        ...
        self.Lb3.insert(3, "4")
        self.Lb3.insert(4, "5")
        self.Lb3.grid(row=crow, column=2, columnspan=1,
                      padx=5, pady=4, sticky=tk.N)
...
###############################################################################
        ...
        self.button_sav = tk.Button(
            top, text="Export Time History", command=self.export_fd)
...
###
        ...
        if (n <= 500000):
            ...
            win = tk.Toplevel()
            from vibrationdata.vb_plot_large_data_array_gui import vb_plot_large_data_array
            vb_plot_large_data_array(
                win, self.TT, self.a, 'Time (sec)', 'Accel (G)', 'Sine Sweep Time History', 1)
