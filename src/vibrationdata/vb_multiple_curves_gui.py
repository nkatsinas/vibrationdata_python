...
################################################################################
        ...
        self.button_read1.grid(
            row=crow, column=0, columnspan=1, padx=3, pady=10)
        ...
        self.button_read2.grid(
            row=crow, column=1, columnspan=1, padx=3, pady=10)

        self.button_read3 = tk.Button(
            top, text="Read Input File 3", command=self.read_data3)
        self.button_read3.config(height=2, width=18)
        self.button_read3.grid(
            row=crow, column=2, columnspan=1, padx=3, pady=10)

        self.button_read4 = tk.Button(
            top, text="Read Input File 4", command=self.read_data4)
        self.button_read4.config(height=2, width=18)
        self.button_read4.grid(
            row=crow, column=3, columnspan=1, padx=3, pady=10)
        ...
        self.L1_string.set('')
        self.L1_string_entry = tk.Entry(
            top, width=26, textvariable=self.L1_string)
        self.L1_string_entry.grid(row=crow, column=0, columnspan=1, pady=5)

        self.L2_string = tk.StringVar()
        self.L2_string.set('')
        self.L2_string_entry = tk.Entry(
            top, width=26, textvariable=self.L2_string)
        self.L2_string_entry.grid(row=crow, column=1, columnspan=1, pady=5)

        self.L3_string = tk.StringVar()
        self.L3_string.set('')
        self.L3_string_entry = tk.Entry(
            top, width=26, textvariable=self.L3_string)
        self.L3_string_entry.grid(row=crow, column=2, columnspan=1, pady=5)

        self.L4_string = tk.StringVar()
        self.L4_string.set('')
        self.L4_string_entry = tk.Entry(
            top, width=26, textvariable=self.L4_string)
        ...
        self.t_string_entry.grid(
            row=crow, column=0, columnspan=1, padx=10, pady=5)
        ...
        self.Legend_status = tk.Listbox(
            top, height=2, width=10, exportselection=0)
        self.Legend_status.insert(1, "On")
        self.Legend_status.insert(2, "Off")
        self.Legend_status.grid(
            row=crow, column=3, padx=10, pady=1, sticky=tk.N)
        ...
        self.button_plot = tk.Button(
            top, text="Plot Curves", command=self.plot)
        self.button_plot.config(height=2, width=18)
        self.button_plot.grid(row=crow, column=1,
                              columnspan=1, padx=3, pady=10, sticky=tk.W)
    ...
    def plot(self):
        ...
        if (p1 == 0 and p2 == 0 and p3 == 0 and p4 == 0):
            tkMessageBox.showinfo(
                "Warning", "Select one or more curves", parent=self.button_plot)
            return
