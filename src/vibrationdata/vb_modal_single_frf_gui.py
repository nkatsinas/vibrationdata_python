...
###############################################################################
        ...
        self.hwtext1 = tk.Label(
            top, text='Calculate the frf from a force and response time history, single record')
        ...
        self.Lb1.grid(row=crow, column=0, columnspan=1,
                      padx=4, pady=10, sticky=tk.S)
...
################################################################################
        ...
        self.button_fftm = tk.Button(
            top, text="Magnitude", command=self.export_fftm)
        ...
        self.button_fftmp.grid(
            row=crow, column=1, columnspan=1, pady=1, padx=8)

        self.button_fftc = tk.Button(
            top, text="Complex", command=self.export_fftc)
...
###
        ...
        plt.plot(self.t, self.c[:, 0], linewidth=1.0,
        ...
        plt.plot(self.t, self.c[:, 1], linewidth=1.0,
                 color='b')        # disregard error
