...
################################################################################
        ...
        self.hwtext5 = tk.Label(
            top, text='Apply Lowpass Filter Prior to Downsampling')
        self.hwtext5.grid(row=crow, column=1, columnspan=2,
                          padx=6, pady=5, sticky=tk.S)

        self.hwtext6 = tk.Label(top, text='Lowpass Filter Frequency (Hz)')
        self.hwtext6.grid(row=crow, column=3, columnspan=2,
                          padx=6, pady=5, sticky=tk.S)
        ...
        self.Lb4.grid(row=crow, column=1, columnspan=1,
                      padx=10, pady=4, sticky=tk.NE)
...
################################################################################
        ...
        self.button_extract = tk.Button(
            top, text="Decimate", command=self.decimate)
...
###############################################################################
        ...
        plt.plot(self.td, self.yd, linewidth=1.0,
                 color='b')        # disregard error
