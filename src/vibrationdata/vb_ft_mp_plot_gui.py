...
from vibrationdata.vb_utilities import read_three_columns_from_dialog
...
################################################################################
        ...
        self.hwtext2 = tk.Label(
            top, text='The input file must have three columns:  freq(Hz) & magnitude & phase')
...
################################################################################
    ...
    def read_data(self):
        ...
        self.ff, self.zz, self.ph, self.num = read_three_columns_from_dialog(
...
####
        ...
        if len(string1) == 0:
            tkMessageBox.showwarning(
                'Warning', 'Enter Starting Frequency ', parent=self.button_read)
            return
        else:
            x1 = float(string1)
        ...
        if len(string2) == 0:
            tkMessageBox.showwarning(
                'Warning', 'Enter End Frequency ', parent=self.button_read)
            return
        else:
            x2 = float(string2)
        ...
        if len(ylab) == 0:
            tkMessageBox.showwarning(
                'Warning', 'Enter Y-axis Label ', parent=self.button_read)
            return
