...
from vibrationdata.vb_utilities import read_three_columns_from_dialog, WriteData2
...
class vb_half_power_bandwidth_fc:
    def __init__(self, parent):
        ...
        self.master.title(
            "vb_half_power_bandwidth_fc_gui.py ver 1.0  by Tom Irvine")

        crow = 0

        self.hwtext1 = tk.Label(
            top, text='This method performs a curve-fit to determine the damping ratio for a system excited by')
        ...
        self.hwtext2 = tk.Label(
            top, text='an applied force.  This method is an extension of the half-power bandwidth method.')
        ...
        self.hwtext3 = tk.Label(
            top, text='The input data must be a frequency response function with frequency & complex magnitude in')
        self.hwtext3.grid(row=crow, column=0, columnspan=6,
                          pady=0, sticky=tk.W)

        crow = crow+1

        self.hwtext4 = tk.Label(
            top, text='three columns:  freq(Hz)  real  imaginary ')
        self.hwtext4.grid(row=crow, column=0, columnspan=6,
                          pady=0, sticky=tk.W)
...
###############################################################################
        ...
        self.hwtext7 = tk.Label(
            top, text='Enter Curve-fit Frequency Limits (Hz) ')
        self.hwtext7.grid(row=crow, column=1, columnspan=2,
                          pady=6, sticky=tk.S)
...
###############################################################################
    ...
    def read_data(self):
        self.f, self.frf_r, self.frf_i, num = read_three_columns_from_dialog(
