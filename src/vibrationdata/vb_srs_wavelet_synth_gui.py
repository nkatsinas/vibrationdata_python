...
from vibrationdata.vb_utilities import read_two_columns_from_dialog, SRS_function, DSS_waveform_reconstruction, SRS_coefficients
...
#                print("ref 6")
                ...
                sym, acc = vb_srs_wavelet_synth.DSS_scale_th(
                    ns, last, acc, amp, sss)
...
#                print("ref 8  %ld  na=%ld" %(ijk,na))
 ...
 #                print("ref 9  %ld" % ijk)
                ...
                syn_error, iflag = vb_srs_wavelet_synth.DSS_srs_error(
...
###############################################################################
        ...
        ds_temp = (self.wavelet_accel[:, 1]) * \
            1.  # keep this to avoid serious error
...
##################
        ...
        plt.subplot(211)
        plt.plot(
            self.wavelet_accel[:, 0], self.wavelet_accel[:, 1], linewidth=1.0, color='b')
