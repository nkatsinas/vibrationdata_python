...
################################################################################
        ...
        self.y_string_entry = tk.Entry(
            top, width=32, textvariable=self.y_string)
        self.y_string_entry.grid(
            row=crow, column=2, columnspan=3, padx=5, pady=3, sticky=tk.W)
...
################################################################################
        ...
        self.hwtext90.grid(row=crow, column=0, columnspan=1,
                           pady=12, sticky=tk.S)
        ...
        self.hwtext94.grid(row=crow, column=2, columnspan=1,
                           pady=12, sticky=tk.S)
