...
###############################################################################
    ...
    def analysis_go(self):
        ...
        if (n == m):
            from vibrationdata.vb_Butterworth_filter_gui import vb_Butterworth_filter
            vb_Butterworth_filter(win)
        m = m+1

        if (n == m):
            from vibrationdata.vb_Bessel_lowpass_filter_gui import vb_Bessel_lowpass_filter
