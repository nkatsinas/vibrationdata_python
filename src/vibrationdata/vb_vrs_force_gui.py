...
###############################################################################
        ...
        self.hwtext3 = tk.Label(
            top, text='This script calculates the VRS for an applied force PSD.')
        ...
        self.hwtext3 = tk.Label(
            top, text='The input file must have two columns: Freq(Hz) & Force(units^2/Hz)')
        ...
        self.hwtext_fn.grid(row=crow, column=1, columnspan=1,
                            padx=14, pady=10, sticky=tk.S)

        self.mass_text = tk.StringVar()
        self.mass_text.set('Enter Mass (lbm)')
        self.hwtext_mass = tk.Label(top, textvariable=self.mass_text)
        self.hwtext_mass.grid(row=crow, column=2,
                              columnspan=1, padx=14, pady=10, sticky=tk.S)
...
#
        for i in range(1, 200):
            if (Q == float(i)):
                title_string = 'Acceleration Vibration Response Spectrum Q=' + \
                    str(i)
                break
...
#
        for i in range(1, 200):
            if (Q == float(i)):
                title_string = 'Displacement Vibration Response Spectrum Q=' + \
                    str(i)
                break
#
        if (nu == 0):
...
#
        Q = 1/(2*damp)
        title_string = 'Transmitted Force Vibration Response Spectrum Q=' + \
            str(Q)
#
        for i in range(1, 200):
            if (Q == float(i)):
