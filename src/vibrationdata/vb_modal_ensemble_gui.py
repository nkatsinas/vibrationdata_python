...
class vb_modal_ensemble_frf:
    ...
    def __init__(self, parent, t, c):
        ...
        self.master.title(
            "vb_modal_ensemble_frf_gui.py ver 1.0  by Tom Irvine")
...
###############################################################################
        ...
        self.hwtext1 = tk.Label(
            top, text='Calculate the frf from a force and response time history')
        self.hwtext1.grid(row=crow, column=0, columnspan=4,
                          pady=6, sticky=tk.W)
        ...
        self.hwtext3.grid(row=crow, column=1, columnspan=1,
                          padx=10, pady=6, sticky=tk.S)

        self.hwtext4 = tk.Label(top, text='Unit')
        self.hwtext4.grid(row=crow, column=2, columnspan=1,
                          padx=4, pady=6, sticky=tk.S)
...
###############################################################################
        ...
        self.hwtext5.grid(row=crow, column=0, columnspan=1,
                          pady=6, sticky=tk.S)
        ...
        self.hwtext73.grid(row=crow, column=2, columnspan=1,
                           pady=6, sticky=tk.S)
        ...
        self.Lb_mr.grid(row=crow, column=1, columnspan=1,
                        padx=4, pady=10, sticky=tk.S)
        ...
        self.Lb_win.grid(row=crow, column=2, columnspan=1,
                         padx=4, pady=10, sticky=tk.S)
        ...
        self.hwtext8.grid(row=crow, column=0, columnspan=1,
                          pady=6, sticky=tk.S)

        self.hwtext9 = tk.Label(top, text='Maximum')
        self.hwtext9.grid(row=crow, column=1, columnspan=1,
                          pady=6, sticky=tk.S)
        ...
        self.button_calculate = tk.Button(
            top, text="Calculate FRF", command=self.calculation)
        ...
        self.hwtextext_exfft = tk.Label(
            top, text='Export Transfer Function Data')
        ...
        self.Lbexp.grid(row=crow, column=0, columnspan=2,
                        padx=10, pady=10, sticky=tk.N)
        ...
        self.button_modal = tk.Button(
            top, text="Modal Analysis", command=self.modal)
...
#        YS=YU
        ...
        try:
            ...
            tkMessageBox.showwarning(
                "Warning", "Select Analysis Option", parent=self.button_calculate)
            return
...
###############################################################################
        ...
        plt.plot(self.t, self.a, linewidth=1.0,
        ...
        plt.plot(self.t, self.b, linewidth=1.0,
                 color='b')        # disregard error
        plt.grid(True)
        plt.xlabel('Time (sec)')
        plt.ylabel(YR)
...
###############################################################################
    ...
    def modal(self):
        ...
        from vibrationdata.vb_half_power_bandwidth_fc_gui import vb_half_power_bandwidth_fc
