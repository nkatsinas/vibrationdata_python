...
################################################################################
        ...
        self.hwtext1 = tk.Label(
            top, text='Plot Time History Signal & Extract Segment')
...
################################################################################
        ...
        self.hwtext3.grid(row=crow, column=2, columnspan=2,
                          pady=7, sticky=tk.S)
        ...
        self.x_string_entry.grid(
            row=crow, column=0, columnspan=2, padx=5, pady=3)
        ...
        self.y_string_entry.grid(
            row=crow, column=2, columnspan=2, padx=5, pady=3,)

        crow = crow+1

        self.hwtext41 = tk.Label(top, text='Start Time (sec) ')
        self.hwtext41.grid(row=crow, column=0, columnspan=1,
                           pady=7, sticky=tk.W)

        self.hwtext42 = tk.Label(top, text='End Time (sec) ')
        self.hwtext42.grid(row=crow, column=1, columnspan=1,
                           pady=7, sticky=tk.W)
...
################################################################################
        ...
        self.tmin_string_entry = tk.Entry(
            top, width=12, textvariable=self.tmin_string)
        self.tmin_string_entry.grid(
            row=crow, column=0, columnspan=3, padx=5, pady=3, sticky=tk.W)

        self.tmax_string = tk.StringVar()
        self.tmax_string.set('')
        self.tmax_string_entry = tk.Entry(
            top, width=12, textvariable=self.tmax_string)
        self.tmax_string_entry.grid(
            row=crow, column=1, columnspan=3, padx=5, pady=3, sticky=tk.W)
...
################################################################################
    ...
    def extract_data(self):
        ...
        plt.plot(self.c, self.d, linewidth=1.0,
