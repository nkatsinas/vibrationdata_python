...
from vibrationdata.vb_utilities import WriteData2, sample_rate_check, \
...
# self.master.geometry("720x610")
        ...
        self.master.title(
            "vb_trend_removal_scaling_gui.py ver 1.3  by Tom Irvine")
...
################################################################################
        ...
        self.hwtext3 = tk.Label(
            top, text='Enter Input Time History Y-axis Label')
        ...
        self.y_string_entry.grid(
            row=crow, column=2, columnspan=3, padx=5, pady=11, sticky=tk.W)

        crow += 1

        self.hwtext39 = tk.Label(
            top, text='Enter Output Time History Y-axis Label')
        self.hwtext39.grid(row=crow, column=0, columnspan=2,
                           pady=11, sticky=tk.E)

        self.yo_string = tk.StringVar()
        self.yo_string.set('')
        self.yo_string_entry = tk.Entry(
            top, width=26, textvariable=self.yo_string)
        self.yo_string_entry.grid(
            row=crow, column=2, columnspan=3, padx=5, pady=11, sticky=tk.W)
...
################################################################################
        ...
        self.hwtext7 = tk.Label(
            top, text='Multiply Amplitude by Scale Factor?')
        self.hwtext7.grid(row=crow, column=0, columnspan=2,
                          pady=11, sticky=tk.W)

        self.hwtext22 = tk.Label(top, text='Enter Scale Factor')
        self.hwtext22.grid(row=crow, column=2, columnspan=1,
                           padx=20, pady=11, sticky=tk.W)
...
################################################################################
        ...
        self.button_calculate_scale.config(
            height=2, width=20, state='disabled')
        self.button_calculate_scale.grid(
            row=crow, column=3, columnspan=2, padx=10, pady=5)
...
################################################################################
        ...
        self.hwtext71.grid(row=crow, column=0, columnspan=2,
                           pady=11, sticky=tk.W)
...
################################################################################
        ...
        self.button_calculate_trend = \
            tk.Button(top, text="Perform Trend Removal",
                      command=self.calculation_trend)
        self.button_calculate_trend.config(
            height=2, width=20, state='disabled')
        self.button_calculate_trend.grid(
            row=crow, column=0, columnspan=2, pady=20)

        self.button_export = tk.Button(
            top, text="Export Output Data", command=self.export)
    ...
    def calculation_trend(self):
        ...
        if (itr == 3):
            ...
            for i in range(0, self.num):
                self.c[i] -= (z[0]*self.a[i]**2 + z[1] *
                              self.a[i] + z[3]*self.a[i])
