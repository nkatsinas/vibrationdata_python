...
################################################################################
        ...
        self.button_read = tk.Button(
            top, text="Read Input Files", command=self.read_data_two)
...
################################################################################
        ...
        self.button_sa = tk.Button(
            top, text="Cross-correlation", command=self.export_cross_correlation)
...
################################################################################
    ...
    def calculation(self):
        ...
        if ((self.dt1-self.dt2)/self.dt2 < 0.001):
            ...
            print(" ")
            print(" Maximum:  Delay=%8.4g sec   Amp=%8.4g " %
                  (self.d[idx], self.cc[idx]))

            title_string = "Cross-correlation  Max: Delay=%6.3g sec   Amp=%7.4g " % (
                self.d[idx], self.cc[idx])
            ...
            plt.plot(self.d, self.cc, linewidth=1.0,
...
################################################################################
    ...
    def read_data_two(self):
        ...
        self.a1, self.b1, self.num1 = read_two_columns_from_dialog(
            'Select First Input File', self.master)
        ...
        self.sr1, self.dt1 = sample_rate_check(
            self.a1, self.b1, self.num1, self.sr1, self.dt1)

###

        self.a2, self.b2, self.num2 = read_two_columns_from_dialog(
            'Select Second Input File', self.master)
        ...
        self.sr2, self.dt2 = sample_rate_check(
            self.a2, self.b2, self.num2, self.sr2, self.dt2)

###
        plt.clf()
        plt.figure(1)

        plt.plot(self.a1, self.b1, linewidth=1.0,
                 color='b')        # disregard error
        ...
        plt.plot(self.a2, self.b2, linewidth=1.0,
                 color='b')        # disregard error
