...
################
        ...
        self.hwtext31.grid(row=crow, column=1, columnspan=1,
                           pady=10, sticky=tk.SW)
        ...
        self.delay_entry.grid(row=crow, column=0,
                              padx=10, pady=1, sticky=tk.NW)
...
################
        ...
        self.hwtext41.grid(row=crow, column=1, columnspan=1,
                           pady=10, sticky=tk.SW)
