...
################################################################################
    ...
    def PerformAnalysis(self):
        ...
        if (n == m):
            from vibrationdata.vb_tire_imbalance_gui import vb_tire_imbalance
            vb_tire_imbalance(win)

        m = m+1

        if (n == m):
            from vibrationdata.vb_tangential_velocity_gui import vb_tangential_velocity
            vb_tangential_velocity(win)

        m = m+1

        if (n == m):
            from vibrationdata.vb_turbine_generator_gui import vb_turbine_generator
