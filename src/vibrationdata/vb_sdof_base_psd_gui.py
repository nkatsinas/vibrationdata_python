...
from vibrationdata.vb_utilities import spectral_moments_constant_df
...
###############################################################################
        ...
        self.hwtext3 = tk.Label(
            top, text='This script calculates the response of an SDOF system to a PSD base input.')
        self.hwtext3.grid(row=crow, column=0, columnspan=4,
                          pady=6, sticky=tk.W)
        ...
        self.button_export = tk.Button(
            top, text="Export Response PSD", command=self.export)
...
# Absolute Acceleration
        ...
        m0, m1, m2, m4, vo, vp = spectral_moments_constant_df(
            self.fi, self.aa_psd, df)
...
################################################################################
        ...
        if (n == 0):
            ...
            print("\n Pseudo Velocity       = %12.4g inch/sec RMS" %
                  (omegan*rrms))
            print("                       = %12.4g inch/sec 3-sigma " %
                  (omegan*rrms*3.))
            ...
            print("\n Pseudo Velocity       = %12.4g cm/sec RMS" %
                  (omegan*rrms*2.54))
            print("                       = %12.4g cm/sec 3-sigma " %
                  (omegan*rrms*2.54*3))
...
################################################################################
        ...
        title_string = 'Power Spectral Density  fn=' + \
            str("%g" % fn)+' Hz  Q=' + str("%g" % Q)
...
###############################################################################
        ...
        title_string = 'Power Transmissibility  fn=' + \
            str("%g" % fn)+' Hz  Q=' + str("%g" % Q)
