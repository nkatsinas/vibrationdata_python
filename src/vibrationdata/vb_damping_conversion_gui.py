...
###############################################################################
        ...
        self.Lb2.grid(row=crow, column=3, columnspan=2,
                      padx=5, pady=4, sticky=tk.N)
        ...
        self.textWidget = tk.Text(
            top, width=40, height=16, font="TkDefaultFont 9")
...
###############################################################################
        ...
        self.button_calculate.grid(
            row=crow, column=1, padx=2, pady=10, sticky=tk.SW)
        ...
        self.button_quit.grid(row=crow, column=2, padx=2,
