...
################################################################################
        ...
        self.hwtext1 = tk.Label(
            top, text='Davenport-King Wind Velocity PSD for Horizontal Gustiness')
        ...
        self.hwtext_v.grid(row=crow, column=1, columnspan=1,
                           padx=15, sticky=tk.S)
...
################################################################################
        ...
        self.mean_velox_entry = tk.Entry(
            top, width=10, textvariable=self.mean_veloxr)
...
################################################################################
        ...
        self.hwtext_scale.grid(
            row=crow, column=0, columnspan=1, padx=15, pady=10, sticky=tk.S)
        ...
        self.hwtext_drag.grid(row=crow, column=1,
                              columnspan=1, padx=15, pady=10, sticky=tk.S)
...
################################################################################
        ...
        self.button_calculate = tk.Button(
            top, text="Calculate", command=self.calculate_data)
        self.button_calculate.config(height=2, width=16)
        self.button_calculate.grid(
            row=crow, column=0, columnspan=1, padx=5, pady=10, sticky=tk.S)

################################################################################

        self.button_sav = tk.Button(
            top, text="Export PSD", command=self.save_data)
        self.button_sav.config(height=2, width=16, state='disabled')
        self.button_sav.grid(row=crow, column=1, columnspan=1,
                             padx=5, pady=10, sticky=tk.S)
        ...
        self.button_quit.grid(row=crow, column=2,
                              columnspan=1, padx=5, pady=10, sticky=tk.S)
...
################################################################################
    ...
    def calculate_data(self):
        ...
        if (n == 1):
            ...
            out1 = ('Davenport-King Spectrum  V=%g m/sec, L=%g m, k=%g' %
                    (V, L, k))
