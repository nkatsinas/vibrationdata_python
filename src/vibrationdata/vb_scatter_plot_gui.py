...
from vibrationdata.vb_utilities import read_two_columns_from_dialog, signal_stats
...
################################################################################
        ...
        self.hwtext1 = tk.Label(
            top, text='Plot Scatter Plot for Two Time Histories')
        ...
        self.hwtext2 = tk.Label(
            top, text='Each input file must have two columns:  time(sec) & amplitude')
...
################################################################################
        ...
        self.hwtext4.grid(row=crow, column=0, columnspan=3,
                          pady=7, sticky=tk.W)
...
################################################################################
        ...
        self.hwtext3 = tk.Label(
            top, text='Enter Time History 1, Y-axis Label ')
        ...
        self.y1_string.set('')
        self.y1_string_entry = tk.Entry(
            top, width=26, textvariable=self.y1_string)
        self.y1_string_entry.grid(
            row=crow, column=0, columnspan=3, padx=5, pady=3, sticky=tk.W)
...
################################################################################
        ...
        self.hwtext5 = tk.Label(
            top, text='Enter Time History 2, Y-axis Label ')
        self.hwtext5.grid(row=crow, column=0, columnspan=3,
                          pady=7, sticky=tk.W)
        ...
        self.y2_string.set('')
        self.y2_string_entry = tk.Entry(
            top, width=26, textvariable=self.y2_string)
        self.y2_string_entry.grid(
            row=crow, column=0, columnspan=3, padx=5, pady=3, sticky=tk.W)
...
################################################################################
    ...
    def plot_data(self):
        ...
        if (self.num1 == self.num2):
            ...
            plt.plot(self.b2, self.b1, marker='*', linestyle='none',
            ...
            tkMessageBox.showinfo(
                "Plot Failed", "Data files have different lengths")
