...
class vb_annular_plate_bending:
    ...
    def __init__(self, parent):
        ...
        self.master.title(
            "vb_annular_plate_bending_gui.py ver 1.0  by Tom Irvine")
...
################################################################################
    ...
    def PerformAnalysis(self):
        ...
        if (n == m):
            from vibrationdata.vb_annular_homogeneous_gui import vb_annular_homogeneous
            vb_annular_homogeneous(win)

        m = m+1

        if (n == m):
            from vibrationdata.vb_annular_honeycomb_gui import vb_annular_honeycomb
