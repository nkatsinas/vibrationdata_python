...
class vb_amplitude_conversion:
    def __init__(self, parent):
        ...
        self.master.title(
            "vb_amplitude_conversion_gui.py  ver 1.0  by Tom Irvine")
...
###############################################################################
    ...
    def analysis_go(self):
        ...
        if (n == m):
            from vibrationdata.vb_sine_amplitude_gui import vb_sine_amplitude
            vb_sine_amplitude(win)

        m = m+1

        if (n == m):
            from vibrationdata.vb_srs_amplitude_gui import vb_srs_amplitude
