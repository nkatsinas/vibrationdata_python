...
class vb_Bessel_lowpass_filter:
    def __init__(self, parent):
        ...
        self.master.title(
            "vb_Bessel_lowpass_filter_gui.py ver 1.2  by Tom Irvine")
...
################################################################################
        ...
        self.hwtext1b = tk.Label(
            top, text='This script applies a Bessel two-pole lowpass filter to a time history.')
...
################################################################################
    ...
    def calculate(self):
        ...
        plt.plot(self.ttime, self.yf, linewidth=1.0,
...
###
        ...
        sr, self.dt, ave, sd, rms, skewness, kurtosis, dur = signal_stats(
            self.ttime, self.yf, self.num)
