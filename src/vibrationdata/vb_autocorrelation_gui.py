...
################################################################################
        ...
        self.button_sa = tk.Button(
            top, text="Autocorrelation", command=self.export_autocorrelation)
...
################################################################################
    ...
    def calculation(self):
        ...
        print(" Maximum:  Delay=%8.4g sec   Amp=%8.4g " %
              (self.d[idx], self.ac[idx]))

        title_string = "Autocorrelation  Max: Delay=%6.3g sec   Amp=%7.4g " % (
            self.d[idx], self.ac[idx])
        ...
        plt.plot(self.d, self.ac, linewidth=1.0,
