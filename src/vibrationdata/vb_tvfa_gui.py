...
################################################################################
        ...
        self.y_string_entry.grid(
            row=crow, column=0, columnspan=1, padx=5, pady=5, sticky=tk.N)
...
################################################################################
        ...
        self.segment_duration_entry = tk.Entry(
            top, width=12, textvariable=self.segment_durationr)
        self.segment_duration_entry.grid(
            row=crow, column=0, columnspan=1, padx=5, pady=5, sticky=tk.N)
...
################################################################################
        ...
        self.button_read.grid(row=crow, column=0,
                              columnspan=1, padx=1, pady=10, sticky=tk.W)
...
###############################################################################
    ...
    def calculate(self):
        ...
        plt.figure(2)
        # disregard error
        plt.plot(tt, peak, linewidth=1.0, label="peak")
        plt.plot(tt, rms,  linewidth=1.0, label="rms")        # disregard error
        # disregard error
        plt.plot(tt, sds,  linewidth=1.0, label="std dev")
        # disregard error
        plt.plot(tt, av,   linewidth=1.0, label="mean")
        plt.grid(True)
        plt.xlabel('Time (sec)')
        ...
        plt.figure(4)
        plt.plot(freq, peak, linestyle='None',
                 marker="*")        # disregard error
        plt.grid(True)
