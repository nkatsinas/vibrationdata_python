...
from vibrationdata.vb_utilities import read_two_columns_from_dialog, signal_stats, sample_rate_check
...
################################################################################
        ...
        self.hwtext1 = tk.Label(
            top, text='Descriptive Statistics of Time History Signal')
...
################################################################################
        ...
        self.hwtext12.grid(row=crow, column=3, columnspan=1,
                           padx=10, pady=7, sticky=tk.W)
...
################################################################################
        ...
        self.bins_string_entry = tk.Entry(
            top, width=10, textvariable=self.bins_string)
        self.bins_string_entry.grid(
            row=crow, column=3, columnspan=1, padx=10, pady=7, sticky=tk.W)
...
################################################################################
        ...
        self.button_replot_histogram = tk.Button(
            top, text="Replot Histogram", command=self.replot_histogram)
        self.button_replot_histogram.config(
            height=2, width=15, state='disabled')
        self.button_replot_histogram.grid(
            row=crow, column=2, columnspan=1, padx=10, pady=10, sticky=tk.W)
